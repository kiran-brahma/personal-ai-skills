...
test("keeps the included sibling icon-font classifier aligned", () => {
  for (const skill of ["faceless-explainer"]) {
...
test("preserves a prominent second accent used outside interactive backgrounds", () => {
  ...
  assert.deepEqual(facelessBrandRolesFromStats(stats, colors), brandRolesFromStats(stats, colors));
});
