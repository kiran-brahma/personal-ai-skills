---
name: architect
description: "Sketch types, signatures, and module structure before code, staying in the loop during implementation. Use when jumping to code locks in the wrong shape."
