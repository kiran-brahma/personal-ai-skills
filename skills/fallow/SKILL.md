---
name: fallow
description: Static analysis for TypeScript/JavaScript via the fallow CLI. Find dead code, duplication, circular deps, complexity hotspots, architecture drift. Not for type checking or linting.
license: MIT
---
