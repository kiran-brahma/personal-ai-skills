...
External media providers, HeyGen authentication, and any paid or hosted generation remain opt-in.
Explain the provider, material being sent, and likely cost before using them. Prefer supplied or local
assets when they are sufficient.
