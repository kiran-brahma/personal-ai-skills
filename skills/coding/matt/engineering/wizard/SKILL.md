---
name: wizard
description: "Generate an interactive bash wizard for steps only a human can do: provisioning, credentials, CI secrets, third-party dashboards, one-off cutovers."
---
