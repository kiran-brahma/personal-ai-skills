...
- `model`: your configured why-investigators model (default `a fast exploration model`)
...
- `subagent_type`: `generalPurpose`
- `model`: your configured why-synthesizer model (default `a high-reasoning model`)
