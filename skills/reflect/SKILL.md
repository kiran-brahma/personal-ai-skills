---
name: reflect
description: Spawn three parallel review subagents over the active transcript, surface learnings, and route each to a skill edit. Use when the user says reflect.
